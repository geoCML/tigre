        ...
        <div className="btn p-2 border border-solid border-stone-700 w-8">
            <div className="z-[999] rounded-md w-1/2 text-white p-5 absolute top-1/3 left-1/2 transform -translate-x-1/3 -translate-y-1/2 bg-stone-950 text-center opacity-90" style={{
                ...
                <div className="grid grid-rows-1 grid-cols-[98%_2%]">
                    <h1 className="text-xl pb-3">Connect to a PostGIS Database</h1>
                ...
                <form className="grid grid-cols-1 grid-rows-3 justify-items-center" onSubmit={ (event) => {
                    ...
                    <div>
                        ...
                        <label htmlFor="db-connect-password" className="text-stone-700">:</label>
                        <input id="db-connect-password" className="m-1 p-1 w-25 bg-stone-800 text-white border-solid border-2 border-stone-800 rounded-md" placeholder="password" type="password"/>

                        <label htmlFor="db-connect-host" className="text-stone-700">@</label>
            ...
            <svg onClick={ () => setFormVisible(!formVisible) } xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-database-add text-stone-500" viewBox="0 0 16 16">
